...
function RenderFirst(customer){
    ...
    "                                            <a class=\"media-item__icon color-red\" href=\"/hfshop10/AdminEditCustomerServlet?Id="+customer.Id+"\">\n" +
    "                                                <div class=\"media-item__icon-text\">"+"img"+"</div>\n" +
    "                                                <img class=\"media-item__thumb\" src=\"" +"/hfshop10/uploads/"+customer.Image+"\" alt=\"#\">\n" +
    "                                            </a>\n" +
    "                                            <div class=\"media-item__right\">\n" +
    "                                                <h5 class=\"media-item__title\"><a href=\"/hfshop10/AdminEditCustomerServlet?Id="+customer.Id+"\">"+customer.Name+"</a></h5><a class=\"text-sm text-grey\" href=\"mailto:#\">"+customer.mail+"</a>\n" +
    "                                            </div>\n" +
    "                                        </div>\n" +
    "                                    </td>\n" +
...
function viewcustom(id){
    window.location.href = "/hfshop10/AdminEditCustomerServlet?Id="+id;
}
