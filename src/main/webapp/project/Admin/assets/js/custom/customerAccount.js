...
function Render(order){
    let content =  "  <tr class=\"table__row\">\n" +
        ...
        "                                        <div class=\"table__status\"><span class=\"table__status-icon color-green\"></span> "+order.Status+"</div>\n" +
        "                                    </td>\n" +
...
function viewcustom(id){
    window.location.href = "/hfshop10/AdminEditOrderServlet?Id="+id;
}
