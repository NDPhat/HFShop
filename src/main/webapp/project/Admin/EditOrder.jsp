                    ...
                    <div class="card__header">
                        <div class="row gutter-bottom-xs justify-content-between flex-grow-1">
                            <div class="col">
                                ...
                                <div class="order-invoice__address"><a href="/admin/customeraccount?Id=${requestScope.user.getId()}"><span class="text-grey-dark"><c:out value="${user.getName()}"/> </span></a>
                                    <br><c:out value="${requestScope.user.getAddress()}"/>
                                   
                                </div>
                            </div>
                            <div class="order-invoice__header-right col-12 col-md-auto">
                                <form class="order-status__form" action="${pageContext.request.contextPath}/AdminEditOrderServlet" method="POST">
                                    <div class="input-group input-group--append">
                                        <input value="${requestScope.order.getId()}" name="Id" type="text" hidden>
                                    ...
                                    <script>
                                        document.getElementById('selcectstatus').value = "${requestScope.order.getStatus()}"
                                    </script>
                    ...
                    <table class="table table--lines table--groups table--striped">
                        ...
                        <tr>
                            <th><span class="text-nowrap">order</span>
                             ...
                             <th><span class="text-nowrap">Name</span>
                            </th>
                        ...
                        <c:forEach var="item" items="${requestScope.ListProduct}">
                            <tr class="table__row">
                                <td class="table__td"><span class="text-light-theme"><c:out value="${item.getId()}"/></span>
                                </td>
                                <td class="table__td text-center text-dark-theme"><c:out value="${item.getProduct().getName()}"/></td>
                                ...
                                <td class="table__td text-nowrap text-dark-theme">$<c:out value="${item.getPrice()*item.getQuantity()}"/></td>
                            </tr>
                        </c:forEach>
                            ...
                            <div class="col-auto">
                                <ul class="card-order__total">
                                    <li class="card-order__total-item card-order__total-footer">
                                        ...
                                        <div class="card-order__total-value">$<c:out value="${requestScope.sum}"/></div>
                                    </li>
                                </ul>
                            </div>
                        </div>
