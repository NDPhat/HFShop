    ...
    <main class="page-content">
        <div class="container">
            <div class="page-header">
                <h1 class="page-header__title">products <span class="text-grey" id="number-product">(0)</span></h1>
            </div>
                            ...
                            <svg class="icon-icon-keyboard-down">
                              <use xlink:href="#icon-keyboard-down"></use>
                                    ...
                                    <div class="dropdown-menu dropdown-menu--right dropdown-menu--fluid js-dropdown-select">
                                        ...
                                        <a id="active-status" class="dropdown-menu__item" href="#" tabindex="0" data-value="Publish" class="active-color"><span class="marker-item color-green"></span> Publish</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col col-lg-auto">
                                <form class="toolbox__search" method="GET">
                                    <div class="input-group input-group--white input-group--prepend">
                                        ...
                                        <input id="search-box"  class="input" type="text" placeholder="Search product" oninput="Search();">
                                    </div>
                                </form>
                            </div>
                        </div>
...
<script src="Admin/assets/js/custom/product.js"></script>
